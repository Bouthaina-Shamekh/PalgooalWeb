...
class DashboardTranslationsSeeder extends Seeder
{
    public function run(): void
    {
        $translations = [
            ...
            'dashboard.Portfolio_Legacy_Status'     => 'حالة قديمة غير مدعومة',
            'dashboard.Portfolio_Unsupported_Status' => 'حالة غير مدعومة',

            'dashboard.Media_Picker_Title'                    => 'اختيار وسائط من المكتبة',
            'dashboard.Media_Picker_Choose_From_Library'      => 'اختر من مكتبة الوسائط',
            'dashboard.Media_Picker_Upload_New'               => 'رفع صورة جديدة',
            'dashboard.Media_Picker_Uploading'                 => 'جارٍ رفع الصور…',
            'dashboard.Media_Picker_All'                       => 'الكل',
            'dashboard.Media_Picker_Images'                    => 'صور',
            'dashboard.Media_Picker_Videos'                    => 'فيديو',
            'dashboard.Media_Picker_Documents'                 => 'مستندات',
            'dashboard.Media_Picker_Other'                     => 'أخرى',
            'dashboard.Media_Picker_Search'                    => 'بحث بالاسم أو العنوان',
            'dashboard.Media_Picker_Search_Placeholder'        => 'بحث بالاسم أو العنوان…',
            'dashboard.Media_Picker_Dropzone'                  => 'اسحب الملفات هنا أو استخدم زر الرفع في الأعلى',
            'dashboard.Media_Picker_Upload_Help'               => 'يدعم الصور حتى 10MB للصورة الواحدة (JPEG, PNG, WEBP, SVG…)',
            'dashboard.Media_Picker_Loading'                   => 'جاري التحميل…',
            'dashboard.Media_Picker_Empty'                     => 'لا توجد وسائط مطابقة حالياً.',
            'dashboard.Media_Picker_Load_More'                 => 'تحميل المزيد من الوسائط',
            'dashboard.Media_Picker_No_More'                   => 'لا يوجد المزيد من الوسائط',
            'dashboard.Media_Picker_Load_Error'                => 'حدث خطأ أثناء تحميل الوسائط.',
            'dashboard.Media_Picker_Unnamed'                   => 'بدون اسم',
            'dashboard.Media_Picker_File'                      => 'ملف',
            'dashboard.Media_Picker_Selected_Items'            => 'العناصر المحددة:',
            'dashboard.Media_Picker_Clear_Selection'           => 'إلغاء التحديد',
            'dashboard.Media_Picker_Confirm_Removal'           => 'تأكيد إزالة الصور',
            'dashboard.Media_Picker_Use_Selected'              => 'استخدام العناصر المحددة',
            'dashboard.Media_Picker_Move_Earlier'              => 'نقل الصورة إلى موضع أبكر',
            'dashboard.Media_Picker_Move_Later'                => 'نقل الصورة إلى موضع لاحق',
            'dashboard.Media_Picker_Moved_Position'            => 'نُقلت الصورة إلى الموضع :position.',
            'dashboard.Media_Picker_Upload_Unavailable'        => 'تعذر رفع الملف، أعد تحميل الصفحة وحاول مجدداً.',
            'dashboard.Media_Picker_Upload_Validation_Error'   => 'تعذر رفع الملف، تحقق من الملف وحاول مجدداً.',
            'dashboard.Media_Picker_Upload_Success'            => 'تم رفع الصورة بنجاح.',
            'dashboard.Media_Picker_Upload_Error'              => 'فشل رفع الصورة، حاول مرة أخرى.',
