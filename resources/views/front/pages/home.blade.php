@php
    $homeSchema = [
        ...
        '@type' => 'WebPage',
        'name' => t('frontend.features_title', 'Palgoals Landing Page'),
        'url' => url()->current(),
        'description' => strip_tags(t('frontend.features_suptitle', 'Managed hosting and digital services')),
        'inLanguage' => app()->getLocale(),
    ];
@endphp

<x-front.layouts.index-layouts
    title="ط¨ط§ظ„ ظ‚ظˆظ„ ظ„طھظƒظ†ظˆظ„ظˆط¬ظٹط§ ط§ظ„ظ…ط¹ظ„ظˆظ…ط§طھ - ظ…ظˆط§ظ‚ط¹ ط§ظ„ظƒطھط±ظˆظ†ظٹط© ظˆط§ط³طھط¶ط§ظپط© ط¹ط±ط¨ظٹط©"
    description="ط´ط±ظƒط© ظپظ„ط³ط·ظٹظ†ظٹط© ظ…طھط®طµطµط© ظپظٹ ط¨ط±ظ…ط¬ط© ظˆطھطµظ…ظٹظ… ط§ظ„ظ…ظˆط§ظ‚ط¹ ط§ظ„ط§ظ„ظƒطھط±ظˆظ†ظٹط© طھظ‚ط¯ظ… ط®ط¯ظ…ط§طھ ط§ط³طھط¶ط§ظپط© ظ…ظˆط§ظ‚ط¹طŒ ط­ط¬ط² ط¯ظˆظ…ظٹظ†طŒظ…ظˆط§ظ‚ط¹ ظˆظˆط±ط¯ط¨ط±ظٹط³طŒط§ط¹ظ„ط§ظ†ط§طھ ط¬ظˆط¬ظ„طŒطھط­ط³ظٹظ† ظ…ط­ط±ظƒط§طھ ط§ظ„ط¨ط­ط«"
    keywords="ط®ط¯ظ…ط§طھ ط­ط¬ط² ط¯ظˆظ…ظٹظ† , ط§ظپط¶ظ„ ط´ط±ظƒط© ط¨ط±ظ…ط¬ظٹط§طھ , ط§ط³طھط¶ط§ظپط© ظ…ظˆط§ظ‚ط¹ , ط§ط³طھط¶ط§ظپط© ظ…ط´طھط±ظƒط© , ط´ط±ظƒط© ط§ط³طھط¶ط§ظپط© ظ…ظˆط§ظ‚ط¹ , ط´ط±ظƒط§طھ ط§ط³طھط¶ط§ظپط© ظ…ظˆط§ظ‚ط¹ , ط§ظپط¶ظ„ ط´ط±ظƒط© ط¨ط±ظ…ط¬ط©, ط®ط¯ظ…ط© ظƒطھط§ط¨ط© ظ…ط­طھظˆظ‰ , طھط­ط³ظٹظ† ظ…ط­ط±ظƒط§طھ ط§ظ„ط¨ط­ط« , web hosting service , shared hosting , best wordpress hosting , web hosting company, domain registration services , best IT company , information technology company , content writing service , best SEO services"
    ...
    <div class="relative z-10 px-4 sm:px-8 lg:px-24 py-20 sm:py-28 lg:py-32 flex flex-col-reverse md:flex-row items-center justify-between gap-12 min-h-[600px] lg:min-h-[700px]">
      ...
      <div class="max-w-xl rtl:text-right ltr:text-left text-center md:text-start">
        <h1 class="text-3xl/20 sm:text-4xl/20  lg:text-5xl/20 font-extrabold text-white leading-tight drop-shadow-lg mb-6">
          ط£ط·ظ„ظ‚ ظ…ظˆظ‚ط¹ظƒ ط§ظ„ط®ط§طµ ط®ظ„ط§ظ„ 5 ط¯ظ‚ط§ط¦ظ‚ ظˆط¨ط£ظ‚ظ„ طھظƒظ„ظپط©
        </h1>
        <p class="text-white/90 text-base sm:text-lg font-light mb-8">
          ط£ظ†ط´ط¦ ظ…ظˆظ‚ط¹ ط§ط­طھط±ط§ظپظٹ ط¨ط³ط±ط¹ط© ط¹ظ„ظ‰ ط£ظ‚ظˆظ‰ ظ…ظ†طµط© ط¹ط±ط¨ظٹط© ظ„طھطµظ…ظٹظ… ط§ظ„ظ…ظˆط§ظ‚ط¹طŒ ظ…ط¹ ظ„ظˆط­ط© طھط­ظƒظ… ظƒط§ظ…ظ„ط©طŒ ظˆظ†ط·ط§ظ‚ ظˆط§ط³طھط¶ط§ظپط© ظ…ط¬ط§ظ†ظٹط©.
        </p>
        <!-- Buttons -->
        <div class="flex flex-row flex-wrap gap-3 justify-center md:justify-start">
          <a href="#templates"
            aria-label="ط§ط¨ط¯ط£ ط§ظ„ط¢ظ† ط¨ط¥ظ†ط´ط§ط، ظ…ظˆظ‚ط¹ظƒ ظ…ط¬ط§ظ†ظ‹ط§"
            class="bg-secondary hover:bg-primary text-white font-bold px-6 py-3 rounded-lg shadow transition text-sm sm:text-base">
            ط§ط¨ط¯ط£ ط§ظ„ط¢ظ† ظ…ط¬ط§ظ†ظ‹ط§
          </a>
          <a href="#templates"
            aria-label="ط§ط³طھط¹ط±ط¶ ظ‚ظˆط§ظ„ط¨ ظ…ظ†طµطھظ†ط§ ط§ظ„ط§ط­طھط±ط§ظپظٹط©"
  ...
  <div class="max-w-7xl mx-auto">
    ...
    <div class="grid gap-16 lg:grid-cols-5 items-center" data-aos="zoom-in" data-aos-delay="100">
      ...
      <div class="lg:col-span-2 flex justify-center">
        <img src="{{ asset('assets/tamplate/images/Fu.svg') }}" alt="ظ…ظ…ظٹط²ط§طھ ط§ظ„ظ…ظ†طµط©"
      ...
      <dl class="lg:col-span-3 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-y-12 gap-x-6 text-center sm:text-start">
        ...
        <div>
          ...
          <dd class="mt-2 text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
            ط§ط·ظ„ظ‚ ظ…ظˆظ‚ط¹ظƒ ط®ظ„ط§ظ„ ط¯ظ‚ط§ط¦ظ‚طŒ ط¯ظˆظ† ط£ظٹ طھط¹ظ‚ظٹط¯ طھظ‚ظ†ظٹ.
          </dd>
        </div>
        ...
        <div>
          <dt class="flex flex-col items-center sm:items-start gap-4">
            ...
            <span class="text-lg font-semibold text-gray-900 dark:text-white">ط¯ط¹ظ… ظپظ†ظٹ ظ…طھظˆط§طµظ„</span>
          </dt>
          <dd class="mt-2 text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
           ظ†ط±ط§ظپظ‚ظƒ ط®ط·ظˆط© ط¨ط®ط·ظˆط©طŒ ط¨ظپط±ظٹظ‚ ط¬ط§ظ‡ط² ط¯ط§ط¦ظ…ظ‹ط§ ظ„ظ…ط³ط§ط¹ط¯طھظƒ.
          </dd>
        </div>
        ...
        <div>
          <dt class="flex flex-col items-center sm:items-start gap-4">
            ...
            <span class="text-lg font-semibold text-gray-900 dark:text-white">ظ„ظˆط­ط© طھط­ظƒظ… ط³ظ‡ظ„ط©</span>
          </dt>
          <dd class="mt-2 text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
            طھط­ظƒظ… ظپظٹ ظƒظ„ طھظپط§طµظٹظ„ ظ…ظˆظ‚ط¹ظƒ ط¨ط³ظ‡ظˆظ„ط© ظ…ظ† ط®ظ„ط§ظ„ ظˆط§ط¬ظ‡ط© ظ…ط±ظٹط­ط© ظˆط³ط±ظٹط¹ط©.
          </dd>
        </div>
        ...
        <div>
          <dt class="flex flex-col items-center sm:items-start gap-4">
            ...
            <span class="text-lg font-semibold text-gray-900 dark:text-white">ط£ظ…ط§ظ† ظˆظ…ظˆط«ظˆظ‚ظٹط©</span>
          </dt>
          <dd class="mt-2 text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
            ظ†ط­ظ…ظٹ ط¨ظٹط§ظ†ط§طھظƒ ط¨ط£ط¹ظ„ظ‰ ظ…ط¹ط§ظٹظٹط± ط§ظ„ط£ظ…ط§ظ† ظˆظ†ط³ط® ط§ط­طھظٹط§ط·ظٹ ظ…ط³طھظ…ط±.
          </dd>
        </div>
        ...
        <div>
          <dt class="flex flex-col items-center sm:items-start gap-4">
            ...
            <span class="text-lg font-semibold text-gray-900 dark:text-white">طھطµظ…ظٹظ… ظ…طھط¬ط§ظˆط¨</span>
          </dt>
          <dd class="mt-2 text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
            ظ…ظˆظ‚ط¹ظƒ ظٹط¸ظ‡ط± ط¨ط£ظپط¶ظ„ ط´ظƒظ„ ط¹ظ„ظ‰ ط§ظ„ط¬ظˆط§ظ„طŒ ط§ظ„طھط§ط¨ظ„طھطŒ ظˆط§ظ„ظƒظ…ط¨ظٹظˆطھط±.
          </dd>
        </div>
        ...
        <div>
          <dt class="flex flex-col items-center sm:items-start gap-4">
            ...
            <span class="text-lg font-semibold text-gray-900 dark:text-white">طھط­ط³ظٹظ† ظ…ط­ط±ظƒط§طھ ط§ظ„ط¨ط­ط«</span>
          </dt>
          <dd class="mt-2 text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
           ظ‡ظٹظƒظ„ظٹط© ظ…ط¯ط±ظˆط³ط© طھط³ط§ط¹ط¯ ظ…ظˆظ‚ط¹ظƒ ظپظٹ ط§ظ„ط¸ظ‡ظˆط± ط¹ظ„ظ‰ Google ظˆط¬ط°ط¨ ط§ظ„ط²ظˆط§ط±.
          </dd>
        </div>
...
<!-- ط®ط¯ظ…ط§طھ ط±ظ‚ظ…ظٹط© ظ…طھظƒط§ظ…ظ„ط© -->
@php
    $services = \App\Models\Service::with('translations')->orderBy('order')->get();
@endphp
<section class="py-20 px-4 sm:px-8 lg:px-24 bg-white" dir="auto" aria-label="ط®ط¯ظ…ط§طھ ط±ظ‚ظ…ظٹط© ظ…طھظƒط§ظ…ظ„ط©">
  <div class="relative">
    <div class="relative z-10 max-w-7xl mx-auto">
      <div class="text-center mb-16">
        <h2 class="text-3xl sm:text-4xl font-extrabold text-primary mb-4 tracking-tight" data-aos="fade-up" data-aos-delay="100">
          ط®ط¯ظ…ط§طھ ط±ظ‚ظ…ظٹط© ظ…طھظƒط§ظ…ظ„ط© طھظ†ط·ظ„ظ‚ ط¨ظƒ ظ†ط­ظˆ ط§ظ„ظ†ط¬ط§ط­
        </h2>
        <p class="text-tertiary text-base sm:text-lg max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="200">
          ظƒظ„ ظ…ط§ طھط­طھط§ط¬ظ‡ ظ„ط¨ظ†ط§ط، ظ…ط´ط±ظˆط¹ظƒ ط§ظ„ط±ظ‚ظ…ظٹ ط¨ظ†ط¬ط§ط­: طھطµظ…ظٹظ… ط§ط­طھط±ط§ظپظٹطŒ ط§ط³طھط¶ط§ظپط© ط³ط±ظٹط¹ط©طŒ طھط³ظˆظٹظ‚ ظپط¹ظ‘ط§ظ„طŒ ظˆط¯ط¹ظ… ظپظ†ظٹ ظ…ط³طھظ…ط± â€“ ط­ظ„ظˆظ„ ظ…طھظƒط§ظ…ظ„ط© ظ…ظ† ظپط±ظٹظ‚ ظˆط§ط­ط¯.
        </p>
      </div>

      <!-- Slider -->
      <div class="swiper mySwiper" aria-label="ظ‚ط§ط¦ظ…ط© ط§ظ„ط®ط¯ظ…ط§طھ ط§ظ„ط±ظ‚ظ…ظٹط©" role="region">
...
<!-- طھطµط§ظ…ظٹظ… ط¹طµط±ظٹط© ظˆط§ط­طھط±ط§ظپظٹط© -->
<section class="bg-background dark:bg-gray-900 text-primary dark:text-white py-16 px-4 sm:px-8 lg:px-16 rtl:text-right ltr:text-left">
  <header class="text-center mb-10">
    <h2 class="text-title-h2 font-extrabold mb-2 animate-fade-in-up" data-aos="fade-up" data-aos-delay="200">
      ظ‚ظˆط§ظ„ط¨ ظˆظˆط±ط¯ط¨ط±ظٹط³ ط§ط­طھط±ط§ظپظٹط© ظ…ط¹ ط§ط³طھط¶ط§ظپط© ظˆط¯ظˆظ…ظٹظ†
    </h2>
    <p class="text-tertiary text-base dark:text-gray-300 sm:text-lg max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="200">
      ط§ط­طµظ„ ط¹ظ„ظ‰ ظ…ظˆظ‚ط¹ ظ…طھظƒط§ظ…ظ„ ط®ظ„ط§ظ„ ط¯ظ‚ط§ط¦ظ‚ ط¨ط§ط®طھظٹط§ط± ظ‚ط§ظ„ط¨ ط§ط­طھط±ط§ظپظٹ ظٹط´ظ…ظ„ ط§ظ„ط§ط³طھط¶ط§ظپط© ظˆط§ظ„ط¯ظˆظ…ظٹظ† ظˆط§ظ„ط¯ط¹ظ… ط§ظ„ظپظ†ظٹ.
    </p>
  </header>
  ...
  <main class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-0 sm:px-12" data-aos="zoom-in" data-aos-delay="200">
    <article style="will-change: transform" class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden relative group transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl animate-fade-in-up border border-primary/10" itemscope itemtype="https://schema.org/Product"  lang="ar">
      <meta itemprop="name" content="ظ‚ط§ظ„ط¨ ظ„ظ„ط£ط²ظٹط§ط، ظˆط§ظ„ظ…ظ„ط§ط¨ط³">
      <meta itemprop="description" content="ظ‚ط§ظ„ط¨ ظ…طھط¬ط± ظ…طµظ…ظ… ط¨ظ…ط§ ظٹطھظ†ط§ط³ط¨ ط¨ظٹط¹ ط§ظ„ظ…ظ„ط§ط¨ط³">
      ...
      <div class="relative">
        <img itemprop="image" src="{{ asset('assets/tamplate/images/2-1-1.webp') }}" type="image/webp" alt="ظ‚ط§ظ„ط¨ ظ…طھط¬ط± ظ…ظ„ط§ط¨ط³ ظ†ط³ط§ط¦ظٹط© ط¹طµط±ظٹ" class="w-full h-40 object-cover transition-transform duration-300 group-hover:scale-105 group-hover:brightness-95" loading="lazy" decoding="async">
        ...
        <div class="absolute top-2 right-2 rtl:right-auto rtl:left-2 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <button class="bg-white/80 dark:bg-white/20 hover:bg-primary text-primary hover:text-white rounded-full p-2 shadow-md transition" title="ظ…ط¹ط§ظٹظ†ط© ط§ظ„ظ‚ط§ظ„ط¨" aria-label="ظ…ط¹ط§ظٹظ†ط© ط§ظ„ظ‚ط§ظ„ط¨" role="button">
          ...
          <button class="bg-white/80 dark:bg-white/20 hover:bg-secondary text-secondary hover:text-white rounded-full p-2 shadow-md transition" title="ط´ط±ط§ط، ط§ظ„ظ‚ط§ظ„ط¨" aria-label="ط´ط±ط§ط، ط§ظ„ظ‚ط§ظ„ط¨" role="button">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
      ...
      <div class="p-5 rtl:text-right ltr:text-left flex flex-col items-start">
        <h3 itemprop="name" class="text-suptitle font-bold mb-1 text-primary/90 dark:text-white group-hover:text-secondary transition-colors leading-snug text-start rtl:text-right ltr:text-left">ظ‚ط§ظ„ط¨ ظ„ظ„ط£ط²ظٹط§ط، ظˆط§ظ„ظ…ظ„ط§ط¨ط³</h3>
        <p itemprop="description" class="text-suptitle font-light mb-2 text-primary/70 dark:text-gray-300 rtl:text-right ltr:text-left leading-relaxed">ظ‚ط§ظ„ط¨ ظ…طھط¬ط± ظ…طµظ…ظ… ط¨ظ…ط§ ظٹطھظ†ط§ط³ط¨ ط¨ظٹط¹ ط§ظ„ظ…ظ„ط§ط¨ط³</p>
        <div class="flex justify-between items-center text-sm font-bold rtl:flex-row-reverse ltr:flex-row mt-3 rtl:text-right ltr:text-left w-full">
          <div class="flex items-center gap-1" aria-label="ط§ظ„طھظ‚ظٹظٹظ… 4 ظ…ظ† 5 ظ†ط¬ظˆظ…">
            <span class="text-yellow-400 text-base" role="img" aria-label="4 ظ…ظ† 5 ظ†ط¬ظˆظ…">âک…âک…âک…âک…âک†</span>
          </div>
  ...
  <footer class="flex justify-center items-center gap-4 mt-10">
    <a href="/templates" class="relative inline-flex items-center justify-center px-10 py-3 overflow-hidden font-extrabold text-lg text-white rounded-lg shadow-lg bg-primary transition-all duration-300 hover:bg-primary/30 focus:outline-none focus:ring-2 focus:ring-secondary focus:ring-offset-2">
      ...
      <span class="relative z-10 flex items-center gap-2 rtl:flex-row ltr:flex-row">
        ...
        ط§ظƒطھط´ظپ ط§ظ„ظ‚ظˆط§ظ„ط¨ ط§ظ„ط§ط­طھط±ط§ظپظٹط©
      </span>
    </a>
  </footer>
</section>
<!-- ط£ط­ط¯ط« ط£ط¹ظ…ط§ظ„ظ†ط§ -->
<section class="dark:bg-gray-900 text-primary dark:text-white py-16 px-4 sm:px-8 lg:px-24 rtl:text-right ltr:text-left" aria-labelledby="why-us-heading">
  <header class="text-center mb-12">
    ...
    <p class="text-tertiary mt-4 text-suptitle max-w-max mx-auto animate-fade-in-up delay-100" data-aos="fade-up" data-aos-delay="200">
      ظ†ط¹طھط² ط¨ط«ظ‚ط© ط£ظƒط«ط± ظ…ظ† 1000 ط¹ظ…ظٹظ„ ط£ط·ظ„ظ‚ظˆط§ ظ…ظˆط§ظ‚ط¹ظ‡ظ… ط§ظ„ط¥ظ„ظƒطھط±ظˆظ†ظٹط© ظ…ط¹ظ†ط§طŒ ظˆظ‡ط§ ظ‡ظٹ ظ†ظ…ط§ط°ط¬ ط­ظ‚ظٹظ‚ظٹط© ظ…ظ† ظ…ط´ط§ط±ظٹط¹ ظ†ظپط°ظ†ط§ظ‡ط§ ط¨ط§ط­طھط±ط§ظپظٹط©.
    </p>
  </header>

  <main class="relative group" aria-label="ظ†ظ…ط§ط°ط¬ ظ…ظ† ط£ط¹ظ…ط§ظ„ظ†ط§" role="region" data-aos="zoom-in" data-aos-delay="200">
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide flex flex-col items-center text-center animate-fade-in-up hover:scale-105 transition-transform duration-300">
          <div class="w-full max-w-xs overflow-hidden rounded-lg">
            <img src="{{ asset('assets/tamplate/images/Group 34130.jpg') }}" role="img" alt="ظ…ظˆظ‚ط¹ ط´ط±ظƒط© ظ…ظ‚ط§ظˆظ„ط§طھ" class="rounded-lg hover:brightness-90 transition duration-300" loading="lazy" decoding="async" />
          </div>
          <h3 class="font-extrabold text-suptitle mt-4 animate-fade-in-up delay-150 text-center text-primary dark:text-white">ظ…ظˆظ‚ط¹ ط´ط±ظƒط© ظ…ظ‚ط§ظˆظ„ط§طھ</h3>
        </div>
         <div class="swiper-slide flex flex-col items-center text-center animate-fade-in-up hover:scale-105 transition-transform duration-300">
          <div class="w-full max-w-xs overflow-hidden rounded-lg">
            <img src="{{ asset('assets/tamplate/images/Group 34130.jpg') }}" role="img" alt="ظ…ظˆظ‚ط¹ ط´ط±ظƒط© ظ…ظ‚ط§ظˆظ„ط§طھ" class="rounded-lg hover:brightness-90 transition duration-300" loading="lazy" decoding="async" />
...
<section id="testimonials" class="bg-background py-20 px-4 sm:px-8 lg:px-24">
  <div class="max-w-4xl mx-auto text-center mb-12">
    <h2 class="text-title-h2 font-extrabold text-primary mb-4" data-aos="fade-up" data-aos-delay="200">
      ظ…ط§ط°ط§ ظٹظ‚ظˆظ„ ط¹ظ…ظ„ط§ط¤ظ†ط§ ط¹ظ† Palgoalsطں
    </h2>
    <p class="text-tertiary text-suptitle mx-auto animate-fade-in-up delay-100" data-aos="fade-up" data-aos-delay="200">
      ط¥ظ„ظٹظƒ ط¢ط±ط§ط، ط­ظ‚ظٹظ‚ظٹط© ظ…ظ† ط¹ظ…ظ„ط§ط¦ظ†ط§ ط­ظˆظ„ ط®ط¯ظ…ط§طھ طھطµظ…ظٹظ… ط§ظ„ظ…ظˆط§ظ‚ط¹ ظˆط§ط³طھط¶ط§ظپط© PalgoalsطŒ ط­ظٹط« طµظ†ط¹ظ†ط§ ط§ظ„ظپط±ظ‚ ظپظٹ ط£ط¹ظ…ط§ظ„ظ‡ظ… ط§ظ„ط±ظ‚ظ…ظٹط©.
    </p>
  </div>
      ...
      <div class="swiper-slide flex justify-center">
        <figure class="testimonial-card" style="will-change: transform, opacity;">
          ...
          <blockquote class="text-suptitle text-[#240B36] font-light mb-6">
            ط®ط¯ظ…طھظ‡ظ… ط§ط®طھطµط±طھ ط¹ظ„ظٹظ†ط§ ط§ظ„ظˆظ‚طھ ظˆط§ظ„ط¬ظ‡ط¯. ظ…ظ† طھطµظ…ظٹظ… ط§ظ„ظ…ظˆظ‚ط¹ ط­طھظ‰ ط¥ط·ظ„ط§ظ‚ ط§ظ„ظ…طھط¬ط±طŒ ظƒظ„ ط´ظٹط، ظƒط§ظ† ط³ظ„ط³ ظˆط³ط±ظٹط¹.
          </blockquote>
          <figcaption class="flex items-center gap-3 mt-auto">
            <img src="./assets/images/user1.webp" loading="lazy" alt="ظ†ط§ط¯ظٹظ† ط®ظ„ظٹظ„ - طµط§ط­ط¨ط© ظ…طھط¬ط± ظ…ظ„ط§ط¨ط³" class="w-12 h-12 rounded-full border-2 border-primary" />
            <div class="text-right">
              <p class="font-bold text-primary text-sm">ظ†ط§ط¯ظٹظ† ط®ظ„ظٹظ„</p>
              <p class="text-xs text-[#5E4A72]">طµط§ط­ط¨ط© ظ…طھط¬ط± ظ…ظ„ط§ط¨ط³</p>
            </div>
          </figcaption>
          <div class="flex gap-1 mt-2 text-yellow-400" aria-label="5 ظ…ظ† 5 ظ†ط¬ظˆظ…">âک…âک…âک…âک…âک…</div>
        </figure>
      </div>
...
<section id="latest-blogs" class="py-20 px-4 sm:px-8 lg:px-24 bg-white dark:bg-gray-950 transition-colors duration-300" aria-labelledby="blog-heading">
  <div class="text-center mb-12">
    ...
    <p class="text-tertiary dark:text-gray-300 text-suptitle font-light animate-fade-in-up delay-100" data-aos="fade-up" data-aos-delay="200">
      ط£ط¯ظˆط§طھ ظˆظ†طµط§ط¦ط­ طھط³ط§ط¹ط¯ظƒ ط¹ظ„ظ‰ طھط·ظˆظٹط± ط£ط¹ظ…ط§ظ„ظƒ ط§ظ„ط±ظ‚ظ…ظٹط© ظˆط§ظ„ط¨ظ‚ط§ط، ط¹ظ„ظ‰ ط§ط·ظ„ط§ط¹ ط¨ط£ط­ط¯ط« ط§ظ„ط§طھط¬ط§ظ‡ط§طھ
    </p>
  </div>
        ...
        <article class="blog-card group bg-white dark:bg-gray-900 dark:shadow-none dark:border-gray-700" itemscope itemtype="https://schema.org/BlogPosting">
          <div class="relative">
            <img src="{{ asset('assets/tamplate/images/wordpress.webp') }}" loading="lazy"
              alt="طµظˆط±ط© ط؛ظ„ط§ظپ ظ…ظ‚ط§ظ„: ظƒظٹظپ طھط¨ط¯ط£ ظ…طھط¬ط±ظƒ ط§ظ„ط¥ظ„ظƒطھط±ظˆظ†ظٹ ط¨ظ†ط¬ط§ط­ ظپظٹ 2024طں"
              class="blog-img">
            <span class="blog-tag bg-primary/90 dark:bg-primary">طھط³ظˆظٹظ‚</span>
          </div>
          <div class="blog-content">
            <h3 class="blog-title text-primary dark:text-white" id="post-title-1" itemprop="headline">
              <a href="/blog/start-your-store-2024" itemprop="url" class="hover:text-secondary dark:hover:text-secondary/80 transition-colors">
                ظƒظٹظپ طھط¨ط¯ط£ ظ…طھط¬ط±ظƒ ط§ظ„ط¥ظ„ظƒطھط±ظˆظ†ظٹ ط¨ظ†ط¬ط§ط­ ظپظٹ 2024طں
              </a>
            </h3>
            <p class="text-suptitle text-tertiary dark:text-gray-300 font-light mb-4" itemprop="description">
              ط®ط·ظˆط§طھ ط¹ظ…ظ„ظٹط© ظˆظ†طµط§ط¦ط­ ط°ظ‡ط¨ظٹط© ظ„ط¥ط·ظ„ط§ظ‚ ظ…طھط¬ط±ظƒ ط§ظ„ط¥ظ„ظƒطھط±ظˆظ†ظٹ ظˆطھط­ظ‚ظٹظ‚ ط£ظˆظ„ظ‰ ظ…ط¨ظٹط¹ط§طھظƒ ط¨ط³ط±ط¹ط©.
            </p>
            <div class="blog-meta">
              <img src="./assets/images/user2.jpg" loading="lazy" alt="ط¹ط§ظ…ط± ظ…ظˆط³ظ‰ - ظƒط§طھط¨ ط§ظ„ظ…ظ‚ط§ظ„"
                class="w-8 h-8 rounded-full border-2 border-primary dark:border-secondary">
              <span class="text-xs text-primary dark:text-white font-bold" itemprop="name">ط¹ط§ظ…ط± ظ…ظˆط³ظ‰</span>
              <time datetime="2024-06-12" class="text-xs text-tertiary dark:text-gray-400" itemprop="datePublished">| 12 ظٹظˆظ†ظٹظˆ 2024</time>
            </div>
          </div>
        </article>
      </div>
  ...
  <!-- ط²ط± ط§ط³طھط¹ط±ط§ط¶ ط§ظ„ظ…ط²ظٹط¯ -->
  <footer class="flex justify-center items-center gap-4 mt-10">
    <a href="/blog" aria-label="ط¹ط±ط¶ ط¬ظ…ظٹط¹ ظ…ظ‚ط§ظ„ط§طھ ط§ظ„ظ…ط¯ظˆظ†ط©"
