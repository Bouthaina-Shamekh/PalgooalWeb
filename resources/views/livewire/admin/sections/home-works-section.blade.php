<div class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg mb-8 border border-gray-200 dark:border-gray-700 space-y-6">
    ...
    <!-- home works Section Fields -->
    <div wire:key="homeWorks-{{ $activeLang }}" class="grid grid-cols-12 gap-6">
    ...
    <div class="text-end">
        <button wire:click="updatehomeWorksSection" class="btn btn-primary">
