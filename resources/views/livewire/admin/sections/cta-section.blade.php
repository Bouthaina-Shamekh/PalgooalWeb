<div class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg mb-8 border border-gray-200 dark:border-gray-700 space-y-6">
    ...
    <div wire:key="cta-{{ $activeLang }}" class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 md:col-span-6 mb-4">
            <label class="form-label">{{ t('section.Badge', 'Badge') }}</label>
            <input type="text" wire:model.defer="translationsData.{{ $activeLang }}.badge" class="form-control" placeholder="{{ t('section.Badge', 'Badge') }}" />
        </div>
        ...
        <div class="col-span-12 md:col-span-6 mb-4">
            <label class="form-label">{{ t('section.Primary_Button_Text', 'Primary button text') }}</label>
            <input type="text" wire:model.defer="translationsData.{{ $activeLang }}.primary_button_text" class="form-control" placeholder="{{ t('section.Primary_Button_Text', 'Primary button text') }}" />
        </div>

        <div class="col-span-12 md:col-span-6 mb-4">
            <label class="form-label">{{ t('section.Primary_Button_URL', 'Primary button URL') }}</label>
            <input type="text" wire:model.defer="translationsData.{{ $activeLang }}.primary_button_url" class="form-control" placeholder="https://example.com" />
        </div>
    </div>

    <div class="text-end">
        <button wire:click="updateCtaSection" class="btn btn-primary">
