        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-10">
                ...
                <aside class="space-y-8">
                    ...
                    <div class="border border-gray-200 dark:border-gray-700 p-4 rounded-xl shadow-md">
                        ...
                        <ul class="space-y-2 text-gray-800" id="categoryFilter">
                            <li>
                                <button data-category="all" wire:click="$set('selectedCategory', 'all')" class="{{ $selectedCategory === 'all' ? 'text-primary hover:text-primary/80 font-bold' : '' }}" aria-label="عرض الكل">الكل</button>
                            </li>
            ...
            <div class="lg:col-span-3">
                ...
                <div class="flex justify-between items-center mb-6">
                    <p id="resultCount" class="text-sm text-gray-600">عرض {{ $templates->count() }} من {{ $templates->total() }} نتيجة</p>
                ...
                @if ($templates->first()?->fallbackNotice)
                    <div class="mb-6 p-4 rounded-lg bg-yellow-50 border border-yellow-300 text-yellow-800 text-sm shadow">
                        بعض المحتوى غير متوفر بلغتك الحالية وتم عرضه باللغة العربية تلقائيًا.
                    </div>
                @endif
                <!-- الشبكة -->
