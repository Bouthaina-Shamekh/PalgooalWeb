...
<x-breadcrumb />
    ...
    <div class="max-w-screen-xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
      ...
      <!-- العمود الأيسر: المعاينة، المميزات، والوصف -->
      <div class="lg:col-span-8 flex flex-col gap-8">
        ...
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/50 rounded-2xl shadow-xl shadow-slate-200/50 dark:shadow-black/20 overflow-hidden">
          ...
          <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <a href="/dist/template/view-templat.html" class="flex items-center justify-center gap-2.5 text-center bg-primary hover:bg-primary/90 text-white py-3 rounded-lg font-bold shadow-lg shadow-primary/30 hover:shadow-primary/40 transition-all duration-300 transform hover:-translate-y-0.5">
        ...
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/50 rounded-2xl shadow-xl shadow-slate-200/50 dark:shadow-black/20 p-6 sm:p-8">
          ...
          <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
            <div class="bg-slate-50 dark:bg-gray-700/50 p-4 rounded-xl text-center border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:shadow-lg hover:border-primary/50 hover:-translate-y-1">
              ...
              <h4 class="font-bold text-sm text-gray-800 dark:text-white">تصميم احترافي</h4>
            </div>
            <div class="bg-slate-50 dark:bg-gray-700/50 p-4 rounded-xl text-center border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:shadow-lg hover:border-primary/50 hover:-translate-y-1">
              <div class="text-4xl mb-2">📱</div>
              <h4 class="font-bold text-sm text-gray-800 dark:text-white">متجاوب</h4>
            </div>
            <div class="bg-slate-50 dark:bg-gray-700/50 p-4 rounded-xl text-center border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:shadow-lg hover:border-primary/50 hover:-translate-y-1">
              <div class="text-4xl mb-2">⚙️</div>
              <h4 class="font-bold text-sm text-gray-800 dark:text-white">مرن</h4>
            </div>
            <div class="bg-slate-50 dark:bg-gray-700/50 p-4 rounded-xl text-center border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:shadow-lg hover:border-primary/50 hover:-translate-y-1">
              <div class="text-4xl mb-2">🚀</div>
              <h4 class="font-bold text-sm text-gray-800 dark:text-white">أداء سريع</h4>
            </div>
            <div class="bg-slate-50 dark:bg-gray-700/50 p-4 rounded-xl text-center border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:shadow-lg hover:border-primary/50 hover:-translate-y-1">
              <div class="text-4xl mb-2">🔍</div>
              <h4 class="font-bold text-sm text-gray-800 dark:text-white">صديق SEO</h4>
            </div>
            <div class="bg-slate-50 dark:bg-gray-700/50 p-4 rounded-xl text-center border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:shadow-lg hover:border-primary/50 hover:-translate-y-1">
              <div class="text-4xl mb-2">💬</div>
              <h4 class="font-bold text-sm text-gray-800 dark:text-white">دعم فني</h4>
            </div>
          </div>
        </div>
        <!-- صندوق وصف القالب -->
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/50 rounded-2xl shadow-xl shadow-slate-200/50 dark:shadow-black/20 p-6 sm:p-8">
          ...
          <div class="prose prose-slate dark:prose-invert max-w-none">
            <p>قالب "أريج الزهور" هو الحل الأمثل لإطلاق متجرك الإلكتروني المتخصص في بيع الزهور والهدايا. تم تصميمه بعناية فائقة ليجمع بين الجمال البصري والأداء العالي، مما يوفر لعملائك تجربة تسوق ممتعة وسلسة.</p>
            <p>بفضل لوحة التحكم السهلة والتوافق الكامل مع ووكومرس، يمكنك إدارة منتجاتك، طلباتك، وعملائك بكل سهولة. القالب متجاوب بالكامل مع جميع الأجهزة، ومُحسَّن لمحركات البحث (SEO  ) لضمان وصولك لأكبر عدد من العملاء المحتملين.</p>
            <ul class="list-disc list-inside">
              <li>تصميم أنيق ومخصص لمتاجر الزهور والهدايا.</li>
              <li>سهولة في التخصيص لتغيير الألوان والخطوط بما يناسب هويتك.</li>
              <li>صفحات منتجات جذابة لعرض بضائعك بأفضل صورة.</li>
            </ul>
          </div>
        </div>
