@php
    ...
    $editorLocaleCodes = collect($languages ?? [])
        ->pluck('code')
        ->filter()
        ->values();
...
<form id="{{ $formId }}" method="{{ strtoupper($formMethod) }}" action="{{ $formAction }}"
    ...
    @php
        ...
        $selectedType = old(
            'type',
            $section->type === 'templates-pages' ? 'templates_listing_showcase' : $section->type,
        );
        ...
        <div class="{{ $sectionBodyClass }}">
            ...
            @foreach ($languages as $index => $language)
                @php
                    ...
                    $secondaryButton = is_array($content['secondary_button'] ?? null)
                        ...
                        $pricingPlanItems = collect($pricingPlansSource)
                            ->map(function ($item) {
                                ...
                                return [
                                    ...
                                    'button_label' => trim(
                                        (string) ($item['button_label'] ?? ($button['label'] ?? '')),
                                    ),
                    ...
                    <div class="{{ $contentGridClass }}">
                            ...
                            <div class="lg:col-span-2">
                                <div data-pricing-category-repeater data-category-item-label="{{ __('Category') }}"
                                    ...
                                    <div class="flex flex-wrap items-start justify-between gap-3">
                                        <div>
                                            <label
                                                class="block text-sm font-medium text-slate-700">{{ __('Pricing Categories') }}</label>
                                        ...
                                        <div class="space-y-3" data-pricing-category-items>
                                            @foreach ($pricingCategoryItems as $categoryIndex => $categoryItem)
                                                <article data-pricing-category-item
                                                    ...
                                                    <div class="space-y-3">
                                                        <div
                                                            class="flex items-center justify-between gap-3 rtl:flex-row-reverse">
                                                            <button type="button" data-pricing-category-drag-handle
                                                                ...
                                                                <i class="ti ti-grip-vertical text-lg leading-none"
                                                                    aria-hidden="true"></i>
                                                            </button>

                                                            <div
                                                                class="flex shrink-0 items-center gap-2 rtl:flex-row-reverse">
                                                                <button type="button" data-duplicate-pricing-category
                                                                    ...
                                                                    <i class="ti ti-copy text-base leading-none"
                                                                        aria-hidden="true"></i>
                                                                </button>
                                                                <button type="button" data-remove-pricing-category
                                                                    ...
                                                                    <i class="ti ti-trash text-base leading-none"
                                                                        aria-hidden="true"></i>
                                                                </button>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div data-pricing-category-body
                                                        class="mt-4 space-y-4 {{ $loop->first ? '' : 'hidden' }}">
                                                        <div>
                                                            <div
                                                                class="flex items-center justify-between gap-3 rtl:flex-row-reverse">
                                                                <label
                                                                ...
                                                                <span
                                                                    class="text-xs text-slate-400">{{ __('Visible to visitors') }}</span>
                                                            </div>
                                                            <input type="text"
                                            ...
                                            <div class="space-y-3">
                                                ...
                                                <button type="button" data-pricing-category-toggle
                                                    ...
                                                    <span
                                                        class="mt-0.5 inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-500">
                                                        <i data-pricing-category-toggle-icon
                                                            class="ti ti-chevron-down text-base leading-none"
                                                            aria-hidden="true"></i>
                                                    </span>
                                                </button>
                                            </div>
                                    ...
                                    <datalist id="{{ $pricingCategoryDatalistId }}"
                                        data-pricing-category-datalist></datalist>
                                </div>
                            </div>
                        @endif
                            ...
                            <div class="lg:col-span-2">
                                <div data-output-repeater data-output-item-label="{{ __('Output') }}"
                                    ...
                                    <div class="flex flex-wrap items-start justify-between gap-3">
                                        <div>
                                            <label
                                                class="block text-sm font-medium text-slate-700">{{ __('Outputs List') }}</label>
                                            <p class="mt-1 text-xs text-slate-500">
                                                    ...
                                                    <div data-output-item-body
                                                        ...
                                                        <div>
                                                            <div
                                                                ...
                                                                <span
                                                                    class="text-xs text-slate-400">{{ __('Visible on the page') }}</span>
                                                            </div>
                                                            <input type="text"
                                                        ...
                                                        @php
                                                            $outputMediaPreviewUrls = $buildMediaPreviewUrls(
                                                        ...
                                                        <div class="grid grid-cols-[4rem_minmax(0,1fr)] gap-3">
                                                            <div data-output-icon-preview
                                                                ...
                                                                @else
                                                                    <span
                                                                        class="h-0.5 w-5 rounded-full bg-red-brand"></span>
                                                                @endif
                                                            </div>
                                                            ...
                                                            <div class="space-y-3">
                                                                <div
                                                                    ...
                                                                    <span
                                                                        class="text-xs text-slate-400">{{ __('Source') }}</span>
                                                                </div>
                                                                <select
                                                                    ...
                                                                    <option value="class"
                                                                        @selected(($outputItem['icon_source'] ?? 'class') === 'class')>
                                                                        {{ __('Tabler Icon') }}</option>
                                                                    <option value="media"
                                                                        @selected(($outputItem['icon_source'] ?? 'class') === 'media')>
                                                                ...
                                                                <div data-output-icon-panel="class" class="space-y-3">
                                                                    ...
                                                                    <div
                                                                        class="flex flex-wrap items-center gap-2 rtl:flex-row-reverse">
                                                                        <button type="button"
                                                                            ...
                                                                            <i class="ti ti-icons text-base leading-none"
                                                                                aria-hidden="true"></i>
                                                                ...
                                                                <div data-output-icon-panel="media"
                                                                    ...
                                                                    <button type="button"
                                                                        ...
                                                                        <i class="ti ti-photo text-base leading-none"
                                                                            aria-hidden="true"></i>
                                                                        <span>{{ __('Choose SVG From Media') }}</span>
                                                                    </button>
                                                                    <div data-output-icon-media-preview
                                                    ...
                                                    <div class="grid grid-cols-[4rem_minmax(0,1fr)] gap-3">
                                                        ...
                                                        <div class="space-y-3">
                                                            ...
                                                            <select
                                                                ...
                                                                data-output-field="icon_source"
                                                                class="block w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900">
                                                                <option value="class">{{ __('Tabler Icon') }}
                                                                </option>
                                                                <option value="media">{{ __('SVG From Media') }}
                                                                </option>
                                                            </select>
                            ...
                            <div class="lg:col-span-2">
                                <div data-service-repeater data-service-item-label="{{ __('Service') }}"
                                    ...
                                    <div class="flex flex-wrap items-start justify-between gap-3">
                                        <div>
                                            <label
                                                class="block text-sm font-medium text-slate-700">{{ __('Services List') }}</label>
                                            <p class="mt-1 text-xs text-slate-500">
                                        ...
                                        <div class="space-y-3" data-service-items>
                                            @foreach ($serviceItems as $serviceIndex => $serviceItem)
                                                <article data-service-item
                                                    ...
                                                    @php
                                                        $serviceMediaPreviewUrls = $buildMediaPreviewUrls(
                                                            $serviceItem['icon_media'] ?? null,
                                                        );
                                                    @endphp
                                                    <div data-service-item-body
                                                        class="mt-4 space-y-4 {{ $loop->first ? '' : 'hidden' }}">
                                                        <div>
                                                            <div
                                                                class="flex items-center justify-between gap-3 rtl:flex-row-reverse">
                                                            ...
                                                            <p class="mt-2 text-xs text-slate-500">
                                                                {{ __('This text appears as one item in the services list.') }}
                                                            </p>
                                                        </div>
                                                        ...
                                                        <div class="grid grid-cols-[4rem_minmax(0,1fr)] gap-3">
                                                            <div data-service-icon-preview
                                                                ...
                                                                @if (($serviceItem['icon_source'] ?? 'class') === 'media' && !empty($serviceMediaPreviewUrls))
                                                                    <img src="{{ $serviceMediaPreviewUrls[0] }}"
                                                                        alt=""
                                                                ...
                                                                @else
                                                                    <svg width="10" height="13"
                                                                        ...
                                                                        aria-hidden="true">
                                                                        <path
                                                                            d="M9.75 6.49512L0 12.9903V-7.34329e-05L9.75 6.49512Z"
                                                                            fill="#BA112C" />
                                                                    </svg>
                                                                @endif
                                                            </div>
                                                            ...
                                                            <div class="space-y-3">
                                                                ...
                                                                <select
                                                                    ...
                                                                    class="block w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900">
                                                                    <option value="class"
                                                                        @selected(($serviceItem['icon_source'] ?? 'class') === 'class')>
                                                                        {{ __('Tabler Icon') }}</option>
                                                                    <option value="media"
                                                                        @selected(($serviceItem['icon_source'] ?? 'class') === 'media')>
                                                                        {{ __('SVG From Media') }}</option>
                                                                </select>

                                                                <div data-service-icon-panel="class"
                                                                    class="space-y-3">
                                                                    <input type="text"
                                                                ...
                                                                <div data-service-icon-panel="media"
                                                                    class="space-y-2 hidden">
                                                                    <input type="hidden"
                                                                    ...
                                                                    <div data-service-icon-media-preview
                                                                        class="flex flex-wrap gap-2">
                        ...
                        @if ($showBuildStepsRepeaterField)
                            <div class="lg:col-span-2" data-build-step-repeater
                                data-build-step-item-label="{{ __('Step') }}"
                                data-build-step-item-hint="{{ __('Click to edit this step') }}">
                                <div class="flex flex-wrap items-start justify-between gap-3">
                                    <div>
                                        <label
                                            class="block text-sm font-medium text-slate-700">{{ __('Build Steps') }}</label>
                                        <p class="mt-1 text-xs text-slate-500">
                                            {{ __('Create the process steps as individual items with their own icon and highlight state.') }}
                                        </p>
                                    </div>
                                    ...
                                    <div class="space-y-3" data-build-step-items>
                                        @foreach ($buildStepItems as $stepIndex => $stepItem)
                                            <article data-build-step-item
                                                ...
                                                <div data-build-step-item-body
                                                    class="mt-4 space-y-4 {{ $loop->first ? '' : 'hidden' }}">
                                                    <div>
                                                        <div
                                                            class="flex items-center justify-between gap-3 rtl:flex-row-reverse">
                                                            <label
                                                                class="block text-sm font-medium text-slate-700">{{ __('Step Title') }}</label>
                                                            <span
                                                                class="text-xs text-slate-400">{{ __('Visible on the page') }}</span>
                                                        </div>
                                                        <input type="text"
                                                        ...
                                                        <p class="mt-2 text-xs text-slate-500">
                                                            {{ __('This text appears inside the process card in the timeline.') }}
                                                        </p>
                                                    </div>

                                                    @php
                                                        $stepMediaPreviewUrls = $buildMediaPreviewUrls(
                                                            $stepItem['icon_media'] ?? null,
                                                        );
                                                    @endphp
                                                    <div class="grid grid-cols-[4rem_minmax(0,1fr)] gap-3">
                                                        ...
                                                        <div class="space-y-3">
                                                            ...
                                                            <select
                                                                ...
                                                                class="block w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900">
                                                                <option value="class" @selected(($stepItem['icon_source'] ?? 'class') === 'class')>
                                                                    {{ __('Tabler Icon') }}</option>
                                                                <option value="media" @selected(($stepItem['icon_source'] ?? 'class') === 'media')>
                                                                    {{ __('SVG From Media') }}</option>
                                                            </select>
                                                            ...
                                                            <div data-build-step-icon-panel="media"
                                                                class="space-y-2 hidden">
                                                                <input type="hidden"
                                                                ...
                                                                <div data-build-step-icon-media-preview
                                                                    class="flex flex-wrap gap-2">
                                        ...
                                        <article data-build-step-item
                                            ...
                                            <div data-build-step-item-body class="mt-4 hidden space-y-4">
                                                ...
                                                <div class="grid grid-cols-[4rem_minmax(0,1fr)] gap-3">
                                                    <div data-build-step-icon-preview
                                                        class="sections-editor-icon-preview flex h-14 w-14 items-center justify-center rounded-2xl border border-red-brand/15 bg-red-brand/5 text-red-brand">
                                                        <i class="ti ti-search text-2xl leading-none"
                                                            aria-hidden="true"></i>
                                                    </div>
                        ...
                        @if ($showFeatureRepeaterField)
                            <div class="lg:col-span-2" data-feature-repeater
                                ...
                                <div class="flex flex-wrap items-start justify-between gap-3">
                                    <div>
                                        <label
                                            class="block text-sm font-medium text-slate-700">{{ __('Campaign Features') }}</label>
                                        <p class="mt-1 text-xs text-slate-500">
                                        ...
                                        @foreach ($campaignFeatureItems as $featureIndex => $featureItem)
                                            <article data-feature-item
                                                ...
                                                <div class="space-y-3">
                                                    ...
                                                    <button type="button" data-feature-toggle
                                                        aria-expanded="{{ $loop->first ? 'true' : 'false' }}"
                                                        class="flex w-full min-w-0 items-start justify-between gap-3 rounded-2xl bg-slate-50/80 px-3 py-3 text-left transition hover:bg-slate-100 rtl:flex-row-reverse rtl:text-right">
                                                        <div class="min-w-0 flex-1">
                                                ...
                                                <div data-feature-item-body
                                                    ...
                                                    @php
                                                        $featureMediaPreviewUrls = $buildMediaPreviewUrls(
                                                            $featureItem['icon_media'] ?? null,
                                                        );
                                                    @endphp
                                                    <div class="grid grid-cols-[4rem_minmax(0,1fr)] gap-3">
                                                        <div data-feature-icon-preview
                                                            ...
                                                            @if (!empty($featureItem['icon']))
                                                                <i class="{{ $featureItem['icon'] }} text-2xl leading-none"
                                                                    aria-hidden="true"></i>
                                                            @else
                                                                <i class="ti ti-check text-2xl leading-none"
                                                                    aria-hidden="true"></i>
                                                            @endif
                                                        </div>
                                                        ...
                                                        <div class="space-y-3">
                                                            ...
                                                            <div data-feature-icon-panel="media"
                                                                class="space-y-2 hidden">
                                                                <input type="hidden"
                                                                ...
                                                                <div data-feature-icon-media-preview
                                                                    class="flex flex-wrap gap-2">
                            ...
                            <div class="lg:col-span-2">
                                <div class="rounded-[1.75rem] bg-slate-50/80 p-4 lg:p-5">
                                    <div class="flex flex-wrap items-start justify-between gap-3">
                                        <div>
                                            <label
                                                class="block text-sm font-medium text-slate-700">{{ __('Mobile App Gallery') }}</label>
                                            <p class="mt-1 text-xs text-slate-500">
                                    ...
                                    <div class="mt-4 space-y-4">
                                        <div class="rounded-3xl bg-white p-4 shadow-sm ring-1 ring-slate-200/70">
                                            <div class="mb-3 flex items-center justify-between gap-3">
                                                <div>
                                                    <p
                                                        class="text-[11px] font-semibold uppercase tracking-[0.32em] text-slate-400">
                                                        {{ __('Screen 01') }}</p>
                                                    <h4 class="mt-1 text-sm font-semibold text-slate-900">
                                                        {{ __('First Screenshot') }}</h4>
                                                    <p class="mt-1 text-xs text-slate-500">
                                                        {{ __('Appears in the first slot of the gallery.') }}</p>
                                                </div>
                                            ...
                                            <x-dashboard.media-picker :name="'translations[' . $code . '][content][image_one]'" :label="__('First Screenshot')"
                                                :button-text="__('Choose Screenshot')" :value="$mobileAppImageOneValue" :preview-urls="$mobileAppImageOnePreviewUrls" :multiple="false"
                                                store-value="id"
                                        ...
                                        <div class="rounded-3xl bg-white p-4 shadow-sm ring-1 ring-slate-200/70">
                                            <div class="mb-3 flex items-center justify-between gap-3">
                                                <div>
                                                    <p
                                                        ...
                                                        {{ __('Screen 02') }}</p>
                                                    <h4 class="mt-1 text-sm font-semibold text-slate-900">
                                                        {{ __('Second Screenshot') }}</h4>
                                                    <p class="mt-1 text-xs text-slate-500">
                                                        {{ __('Appears in the middle slot of the gallery.') }}</p>
                                                </div>
                                            ...
                                            <x-dashboard.media-picker :name="'translations[' . $code . '][content][image_two]'" :label="__('Second Screenshot')"
                                                :button-text="__('Choose Screenshot')" :value="$mobileAppImageTwoValue" :preview-urls="$mobileAppImageTwoPreviewUrls"
                                        ...
                                        <div class="rounded-3xl bg-white p-4 shadow-sm ring-1 ring-slate-200/70">
                                            <div class="mb-3 flex items-center justify-between gap-3">
                                                <div>
                                                    <p
                                                        ...
                                                        {{ __('Screen 03') }}</p>
                                                    <h4 class="mt-1 text-sm font-semibold text-slate-900">
                                                        {{ __('Third Screenshot') }}</h4>
                                                    <p class="mt-1 text-xs text-slate-500">
                                                        {{ __('Appears in the third slot of the gallery.') }}</p>
                                                </div>
                                            ...
                                            <x-dashboard.media-picker :name="'translations[' . $code . '][content][image_three]'" :label="__('Third Screenshot')"
                                                :button-text="__('Choose Screenshot')" :value="$mobileAppImageThreeValue" :preview-urls="$mobileAppImageThreePreviewUrls"
                                                :multiple="false" store-value="id"
                        ...
                        @if ($showDesignGalleryField)
                            <div class="lg:col-span-2">
                                <div class="mb-3">
                                    <label
                                        class="block text-sm font-medium text-slate-700">{{ __('Design Gallery') }}</label>
                                    <p class="mt-1 text-xs text-slate-500">
                                ...
                                <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
                                    <div>
                                        <x-dashboard.media-picker :name="'translations[' . $code . '][content][image_one]'" :label="__('Image 1')"
                                            :button-text="__('Choose From Media Library')" :value="$mobileAppImageOneValue" :preview-urls="$mobileAppImageOnePreviewUrls" :multiple="false"
                                            store-value="id" data-shared-media-group="design-showcase-image-one" />
                                    </div>

                                    <div>
                                        <x-dashboard.media-picker :name="'translations[' . $code . '][content][image_two]'" :label="__('Image 2')"
                                            :button-text="__('Choose From Media Library')" :value="$mobileAppImageTwoValue" :preview-urls="$mobileAppImageTwoPreviewUrls" :multiple="false"
                                            store-value="id" data-shared-media-group="design-showcase-image-two" />
                                    </div>

                                    <div>
                                        <x-dashboard.media-picker :name="'translations[' . $code . '][content][image_three]'" :label="__('Image 3')"
                                            :button-text="__('Choose From Media Library')" :value="$mobileAppImageThreeValue" :preview-urls="$mobileAppImageThreePreviewUrls" :multiple="false"
                                            store-value="id"
                                            data-shared-media-group="design-showcase-image-three" />
                                    </div>

                                    <div>
                                        <x-dashboard.media-picker :name="'translations[' . $code . '][content][image_four]'" :label="__('Image 4')"
                                            :button-text="__('Choose From Media Library')" :value="$designImageFourValue" :preview-urls="$designImageFourPreviewUrls" :multiple="false"
                                            store-value="id" data-shared-media-group="design-showcase-image-four" />
                                    </div>

                                    <div>
                                        <x-dashboard.media-picker :name="'translations[' . $code . '][content][image_five]'" :label="__('Image 5')"
                                            :button-text="__('Choose From Media Library')" :value="$designImageFiveValue" :preview-urls="$designImageFivePreviewUrls" :multiple="false"
                                            store-value="id" data-shared-media-group="design-showcase-image-five" />
                                    </div>

                                    <div>
                                        <x-dashboard.media-picker :name="'translations[' . $code . '][content][image_six]'" :label="__('Image 6')"
                                            :button-text="__('Choose From Media Library')" :value="$designImageSixValue" :preview-urls="$designImageSixPreviewUrls" :multiple="false"
                                            store-value="id" data-shared-media-group="design-showcase-image-six" />
                                    </div>
                                </div>
                        ...
                        @if ($showDigitalMarketingGalleryField)
                            <div class="lg:col-span-2">
                                <div class="mb-3">
                                    <label
                                        class="block text-sm font-medium text-slate-700">{{ __('Marketing Gallery') }}</label>
                                    <p class="mt-1 text-xs text-slate-500">
                        ...
                        @if ($showTechStackMediaField)
                            <div class="lg:col-span-2">
                                <div class="mb-3">
                                    <label
                                        class="block text-sm font-medium text-slate-700">{{ __('Technology Logos') }}</label>
                                    <p class="mt-1 text-xs text-slate-500">
                                ...
                                <x-dashboard.media-picker :name="'translations[' . $code . '][content][logos]'" :label="__('Stack Logos')" :button-text="__('Choose From Media Library')"
                                    :value="$techStackLogosValueForComponent" :preview-urls="$techStackLogoPreviewUrls" :multiple="true" store-value="id"
                        ...
                        @if ($showMediaUrlField)
                            @if ($isHeroCampaign || $isProgrammingShowcase)
                                <div class="lg:col-span-2">
                                    <x-dashboard.media-picker :name="'translations[' . $code . '][content][media_url]'" :label="$isProgrammingShowcase ? __('Featured Image') : __('Illustration')" :button-text="__('Choose From Media Library')"
                                        :value="$campaignIllustrationValue" :preview-urls="$campaignIllustrationPreviewUrls" :multiple="false" store-value="id"
