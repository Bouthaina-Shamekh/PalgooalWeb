                    ...
                    <div class="{{ $contentGridClass }}">
                        ...
                        @if ($isDesignShowcase)
                            <div class="lg:col-span-2 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-600">
                                {{ __('This section uses a brand label, one main heading, a services list, one CTA button, and a six-image design gallery.') }}
                            </div>
                        @endif
                        ...
                        @if ($showBrandFields)
                            <div class="{{ ($isProgrammingShowcase || $isMobileAppShowcase) ? 'lg:col-span-2' : '' }}">
                        ...
                        @if ($showMainTitleField)
                            <div class="{{ ($isHeroCampaign || $isProgrammingShowcase || $isMobileAppShowcase) ? 'lg:col-span-2' : '' }}">
                                <label class="block text-sm font-medium text-slate-700">
                        ...
                        @if ($showServicesTextareaField)
                            <div class="lg:col-span-2">
                                ...
                                <textarea
                                    name="translations[{{ $code }}][content][services_textarea]"
                                    rows="6"
                                    class="mt-2 block w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900"
                                >{{ $servicesTextarea }}</textarea>
                                <p class="mt-2 text-xs text-slate-500">{{ __('Each line becomes one design service item in the list.') }}</p>
                            </div>
                        @endif
                        ...
                        @if ($showPrimaryButtonFields && ! $isHeroCampaign)
                            ...
                            @if ($isProgrammingShowcase || $isMobileAppShowcase)
                                <div class="lg:col-span-2">
                                    <label class="inline-flex items-center gap-3 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-medium text-slate-700">
                                        <input
                                            type="checkbox"
