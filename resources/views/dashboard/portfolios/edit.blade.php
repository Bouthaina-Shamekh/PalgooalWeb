<x-dashboard-layout>
    ...
    <div class="page-header">
        <div class="page-block">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{ t('dashboard.Edit_Portfolio', 'Edit Portfolio') }}</li>
            </ul>
            <div class="page-header-title">
                <h2 class="mb-0">
                    {{ t('dashboard.Edit_Portfolio', 'Edit Portfolio') }}
                    @php
    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 xl:col-span-8">
            <form action="{{ route('dashboard.portfolios.update', $portfolio->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
