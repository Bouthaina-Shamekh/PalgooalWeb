                    ...
                    <form action="{{ route('dashboard.subscriptions.store') }}" method="POST"
                        ...
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <select name="domain_option" class="form-select" required>
                                <option value="new" {{ old('domain_option') == 'new' ? 'selected' : '' }}>تسجيل
                                    دومين جديد</option>
                                <option value="subdomain" {{ old('domain_option') == 'subdomain' ? 'selected' : '' }}>
                        ...
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <select name="status" class="form-select" required>
                                <option value="pending" {{ old('status') == 'pending' ? 'selected' : '' }}>معلق
                                </option>
                                ...
                                <option value="expired" {{ old('status') == 'expired' ? 'selected' : '' }}>منتهي
                                </option>
                            </select>
                            @error('status')
                                <span class="text-red-600">{{ $message }}</span>
