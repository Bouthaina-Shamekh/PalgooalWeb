<x-dashboard-layout>
    ...
    <div class="page-header">
        <div class="page-block">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{ t('dashboard.Edit_Category', 'Edit Category') }}</li>
            </ul>
            <div class="page-header-title">
                <h2 class="mb-0">{{ t('dashboard.Edit_Plan_Category', 'Edit Plan Category') }}</h2>
            </div>
        </div>
    </div>
    ...
    <form action="{{ route('dashboard.plan_categories.update', ['plan_category' => $category->id]) }}"
          method="POST">
        @csrf
        @method('PUT')
            ...
            <div class="col-span-12 xl:col-span-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-5">
                            ...
                            @php
                                $currentActive = old('is_active', $category->is_active ? '1' : '0');
                            @endphp
                        ...
                        {{-- Language Panes --}}
                        @foreach ($locales as $lang)
                            @php $trans = $category->translations->where('locale', $lang->code)->first(); @endphp
                            <div id="pane-{{ $lang->code }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="translations[{{ $lang->code }}][description]"
                                              ...
                                              placeholder="{{ t('dashboard.Category_Desc_Placeholder', 'Short description of this category…') }}">{{ old('translations.' . $lang->code . '.description', $trans?->description) }}</textarea>
                ...
                <div class="flex items-center gap-3 mt-2">
                    <button type="submit" class="btn btn-primary flex items-center gap-2">
                        ...
                        {{ t('dashboard.Update_Category', 'Update Category') }}
                    </button>
