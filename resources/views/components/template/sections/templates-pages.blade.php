            ...
            <aside class="space-y-8">
                ...
                <div class="border border-gray-200 dark:border-gray-700 p-4 rounded-xl shadow-md">
                    ...
                    <ul class="space-y-2 text-gray-800" id="categoryFilter">
                        <li>
                            <button data-category="all" class="filter-btn {{ $selectedCategory === 'all' ? 'text-primary hover:text-primary/80 font-bold' : '' }}" aria-label="عرض الكل">الكل</button>
                        </li>
                        @foreach ($categories as $cat)
                        <li>
                            <button
                                onclick="filterByCategory('{{ $cat->id }}')"
                                class="filter-btn {{ $selectedCategory == $cat->id ? 'text-primary font-bold' : '' }}"
                                aria-label="{{ $cat->translated_name }}">
                                {{ $cat->translated_name ?? 'بدون اسم' }}
                            </button>
                        </li>
                        @endforeach
                    </ul>
                ...
                <div class="border border-gray-200 dark:border-gray-700 p-4 rounded-xl shadow-md">
                    ...
                    <p class="text-sm text-gray-700">السعر الأقصى: <span id="priceValue">250</span>$</p>
                </div>
            </aside>
            <!-- شبكة القوالب -->
