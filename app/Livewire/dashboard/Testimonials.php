...
class Testimonials extends Component
{
    ...
    public function save()
    {
        ...
        if ($this->testimonialId) {
            ...
            $this->showAlert('تم تحديث الشهادة بنجاح.', 'success');
        } else {
            $testimonial = Testimonial::create($data);
            $this->showAlert('تم إضافة الشهادة بنجاح.', 'success');
        }
    ...
    public function deleteTestimonialConfirmed($id)
    {
        try {
            ...
            $this->showAlert('تم حذف الشهادة بنجاح.', 'success');
        } catch (\Exception $e) {
            logger()->error('خطأ أثناء حذف الشهادة: ' . $e->getMessage());
            $this->dispatch('testimonial-delete-failed');
            $this->showAlert('تعذر حذف الشهادة، حاول مرة أخرى.', 'danger');
        }
